  ...
  Future<void> _addSampleRecipes() async {
    final sampleRecipes = [
      ...
      Recipe(
        ...
        imageUrl: 'https://www.allrecipes.com/thmb/9wiMmExDMkHsRJ1YQEwkCbQk4bM=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/223382_chicken-stir-fry_Rita-1x1-1-b6b835cceb234e66be2b6a52e69b9a5a.jpg',
        ingredients: [
          'Chicken breast', 'Bell peppers', 'Broccoli', 'Carrots', 'Soy sauce', 'Garlic', 'Ginger', 'Rice'
        ],
        instructions: [
      ...
      Recipe(
        name: 'Vegetable Soup',
        imageUrl: 'https://www.allrecipes.com/thmb/vI4v8E_uQbYPTJyvMRnpK4SQgXE=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/13338-homemade-vegetable-soup-DDMFS-4x3-7a9263011f1e4fdb8bc9309d83e7bdf7.jpg',
        ingredients: [
          'Carrots', 'Celery', 'Onion', 'Potatoes', 'Tomatoes', 'Vegetable broth', 'Herbs', 'Salt', 'Pepper'
        ],
        instructions: [
          'Chop all vegetables.',
      ...
      Recipe(
        ...
        imageUrl: 'https://www.allrecipes.com/thmb/8QzNWDvGhdupDFqz0EYAoVlJZXE=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/20334-banana-pancakes-mfs-74-d0b2e81f2c4f44a1a1b9975026b37a81.jpg',
        ingredients: [
          'Flour', 'Baking powder', 'Sugar', 'Salt', 'Milk', 'Egg', 'Butter', 'Banana'
        ],
        instructions: [
      ...
      Recipe(
        name: 'Greek Salad',
        imageUrl: 'https://www.allrecipes.com/thmb/akF9cX5vaiybdJJIxGwRBV9dOl4=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/1169606-b6c0c630a5d3435dbc7a8c6c1a0e0d1f.jpg',
        ingredients: [
      ...
      Recipe(
        name: 'Beef Tacos',
        imageUrl: 'https://www.allrecipes.com/thmb/kYnG_u3xR8K5-Hg5zwT-llQHbkI=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/70935-taco-seasoning-i-DDMFS-4x3-28bce2ae2c484d76ae6b5374e0rebeca.jpg',
        ingredients: [
          'Ground beef', 'Taco seasoning', 'Taco shells', 'Lettuce', 'Tomato', 'Cheese', 'Sour cream', 'Salsa'
        ],
        instructions: [
      ...
      Recipe(
        name: 'Apple Pie',
        imageUrl: 'https://www.allrecipes.com/thmb/X8k8CYGvbTBCRgbKALpEcTjXN2U=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/12682-apple-pie-by-grandma-ople-DDMFS-4x3-b761a2a7bea14d1cb5caf783b643878b.jpg',
        ingredients: [
      ...
      Recipe(
        ...
        imageUrl: 'https://www.allrecipes.com/thmb/xKCrHXXh3L-pVOXiJl8dmkRXFbY=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/85389-gourmet-mushroom-risotto-DDMFS-4x3-a8a80a3b35524b07b6e0c300d799a089.jpg',
        ingredients: [
      ...
      Recipe(
        ...
        imageUrl: 'https://www.allrecipes.com/thmb/oVYdY5QZJaGJwBULiDRXPUkYrko=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/10813-best-chocolate-chip-cookies-mfs-step-7-148-5c8d2a0c46e0fb0001a1c38c.jpg',
        ingredients: [
          'Butter', 'White sugar', 'Brown sugar', 'Eggs', 'Vanilla extract', 'Flour', 'Baking soda', 'Salt', 'Chocolate chips'
        ],
        instructions: [
      ...
      Recipe(
        ...
        imageUrl: 'https://www.allrecipes.com/thmb/3l79N93Nwzp9q0S_mUZfAzLOtQU=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/87148-coconut-curry-tofu-DDMFS-4x3-e7ac9c1d09864b1d9d1d1047a2b17eef.jpg',
        ingredients: [
          'Potatoes', 'Carrots', 'Peas', 'Cauliflower', 'Onion', 'Garlic', 'Curry powder', 'Coconut milk', 'Vegetable broth', 'Rice'
        ],
        instructions: [
